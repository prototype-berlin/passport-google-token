...
export default class GoogleTokenStrategy extends OAuth2Strategy {
  constructor(_options, _verify) {
    ...
    const _apiVersion = options.apiVersion || 'v3';

    options.authorizationURL = options.authorizationURL || `https://www.google.com/${_apiVersion}/dialog/oauth`;
    options.tokenURL = options.tokenURL || `https://graph.google.com/${_apiVersion}/oauth/access_token`;
    ...
    this._profileURL = options.profileURL || `https://www.googleapis.com/oauth2/${_apiVersion}/userinfo`;
